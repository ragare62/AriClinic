<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppointmentTypeGrid.aspx.cs" Inherits="AppointmentTypeGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewAppointmentTypeRecord()
          {
              var w1 = window.open("AppointmentTypeForm.aspx", null, "width=500, height=400,resizable=1");
              w1.focus();
          }
          function EditAppointmentTypeRecord(id)
          {
              var w2 = window.open("AppointmentTypeForm.aspx?AppointmentTypeId=" + id, null, "width=500, height=400,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Tipos de citas" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" PageSize="6" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
                             DataKeyNames="AppointmentTypeId">
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="AppointmentTypeId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         meta:resourceKey="GridBoundColumnResource1" ReadOnly="True" 
                                         SortExpression="AppointmentTypeId" UniqueName="AppointmentTypeId" 
                                         FilterControlAltText="Filter AppointmentTypeId column">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewAppointmentTypeRecord();" 
