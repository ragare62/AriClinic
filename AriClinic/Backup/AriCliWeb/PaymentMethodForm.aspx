<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentMethodForm.aspx.cs" Inherits="PaymentMethodForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="210px" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Forma de pago"></asp:Label>
        </div>
        <div id="PaymentMethodId" class="normalText">
          <asp:Label ID="lblPaymentMethodId" runat="server" Text="ID:" 
                     ToolTip="Identificador de forma de pago, lo usa internamente el sistema"></asp:Label>
          <br />
          <asp:TextBox ID="txtPaymentMethodId" runat="server" Enabled="false" Width="89px"></asp:TextBox>
        </div>

        <div id="Name" class="normalText">
          <asp:Label ID="lblName" runat="server" Text="Nombre forma de pago:" 
                     ToolTip="Nombre a asignar a la forma de pago"></asp:Label>
          <br />
