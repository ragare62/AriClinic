<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentMethodGrid.aspx.cs" Inherits="PaymentMethodGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewPaymentMethodRecord()
          {
              var w1 = window.open("PaymentMethodForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditPaymentMethodRecord(id)
          {
              var w2 = window.open("PaymentMethodForm.aspx?PaymentMethodId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
    ...
    <telerik:RadToolTipManager ID="RadToolTipManager1" runat="server" 
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Formas de pago" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007"
            ...
            <MasterTableView AutoGenerateColumns="False" datakeynames="PaymentMethodId" 
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="PaymentMethodId" DataType="System.Int32" 
                        FilterControlAltText="Filter PaymentMethodId column" HeaderText="ID" 
                        meta:resourcekey="GridBoundColumnResource1" ReadOnly="True" 
                        SortExpression="PaymentMethodId" UniqueName="PaymentMethodId">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="Name" 
                        FilterControlAltText="Filter Name column" HeaderText="Forma de pago" 
                ...
                <CommandItemTemplate>
                    <div ID="ButtonAdd" style="padding:2px;">
                        <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                            meta:resourcekey="NewResource1" OnClientClick="NewPaymentMethodRecord();" 
