<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaquimetryForm.aspx.cs" Inherits="PaquimetryForm" %>
      ...
      <div id="content"> 
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" Height="600px">
              ...
              <td colspan="2" class="normalText">
                <div id="Examination" style="padding:5px">
                  ...
                  <asp:ImageButton ID="btnExamination" runat="server" 
                                   ...
                                   OnClientClick="searchExamination('paquimetry');" />
                  <br />
          ...
          <table width="100%">
            ...
            <tr>
              <td class="normalText">
                <asp:Label ID="lblCC0" runat="server" Text="Central C0:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtCC0Right" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtCC0Left" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
            <tr>
              <td class="normalText">
                <asp:Label ID="lblC1" runat="server" Text="C1:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC1Right" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC1Left" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
            <tr>
              <td class="normalText">
                <asp:Label ID="lblC3" runat="server" Text="C3:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC3Right" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC3Left" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
            <tr>
              <td class="normalText">
                <asp:Label ID="lblC5" runat="server" Text="C5:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC5Right" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC5Left" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
            <tr>
              <td class="normalText">
                <asp:Label ID="lblC7" runat="server" Text="C7:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC7Right" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtC7Left" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
