<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClinicForm.aspx.cs" Inherits="ClinicForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              var w1 = window.open("AddressForm.aspx?ClinicId=" + gup('ClinicId'), "clinic_na", "width=700, height=350,resizable=1");
              w1.focus();
          }
          function EditAddressRecord(id)
          {
              var w2 = window.open("AddressForm.aspx?ClinicId=" + gup('ClinicId') + "&AddressId=" + id
                                   , "clinic_ea"
          ...
          {
              var w3 = window.open("TelephoneForm.aspx?ClinicId=" + gup('ClinicId'), "clinic_nt", "width=650, height=250,resizable=1");
              w3.focus();
          }
          function EditTelephoneRecord(id)
          {
              var w4 = window.open("TelephoneForm.aspx?ClinicId=" + gup('ClinicId') + "&TelephoneId=" + id
                                   , "clinic_et"
          ...
          {
              var w5 = window.open("EmailForm.aspx?ClinicId=" + gup('ClinicId'), "clinic_ne", "width=650, height=250,resizable=1");
              w5.focus();
          }
          function EditEmailRecord(id)
          {
              var w6 = window.open("EmailForm.aspx?ClinicId=" + gup('ClinicId') + "&EmailId=" + id
                                   , "clinic_ee"
                                   , "width=650, height=250,resizable=1");
              w6.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Clinica"></asp:Label>
        </div>
        <div id="ClinicId" class="normalText">
          <asp:Label ID="lblClinicId" runat="server" Text="ID:" 
                     ToolTip="Identificador de clinica, lo usa internamente el sistema"></asp:Label>
          <br />
          <asp:TextBox ID="txtClinicId" runat="server" Enabled="false" Width="89px"></asp:TextBox>
        </div>
        <div id="Name" class="normalText">
          <asp:Label ID="lblName" runat="server" Text="Nombre de la clinica:" 
                     ToolTip="Nombre a asignar a la clinica"></asp:Label>
          <br />
          <asp:TextBox ID="txtName" runat="server" Width="437px"></asp:TextBox>
        </div>

        <div ID="RemoteIp" class="normalText">
          <asp:Label ID="lblRemoteIp" runat="server" Text="IP Remota:" 
                     ToolTip="Dirección IP desde la que se produce la conexión de esta clínica"></asp:Label>
          <br />
          <asp:TextBox ID="txtRemoteIp" runat="server" Width="119px"></asp:TextBox>
        </div>
        ...
        <div ID="Address" class="embGrid">
          <asp:Label ID="lblAddress" runat="server" Text="Direcciones:" 
                     ToolTip="Direcciones postales de la clinica. La resaltada es la principal"></asp:Label>
          <br />
