<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClinicGrid.aspx.cs" Inherits="ClinicGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          function NewClinicRecord()
          {
              var w1 = window.open("ClinicForm.aspx", null, "width=750, height=604,resizable=1");
              w1.focus();
          }
          function EditClinicRecord(id)
          {
              var w2 = window.open("ClinicForm.aspx?ClinicId=" + id, null, "width=750, height=604,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="350px" 
        ...
        <div id="GridArea" class="normalText">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" Width="436px" 
            ...
            <MasterTableView AutoGenerateColumns="false" datakeynames="ClinicId" CommandItemDisplay="Top">
              <Columns>
                <telerik:GridBoundColumn DataField="ClinicId" DataType="System.Int32" 
                                         HeaderText="ID" ReadOnly="true" Visible="true" 
                                         UniqueName="ClinicId" SortExpression="ClinicId"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Name" DataType="System.String"
                                         HeaderText="Clinica" ReadOnly="true" Visible="true" 
