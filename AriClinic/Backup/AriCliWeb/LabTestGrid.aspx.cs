...
public partial class LabTestGrid : System.Web.UI.Page 
{
    ...
    {
        // load grid data
        RadGrid1.DataSource = CntAriCli.GetLabTests(ctx);
    }
    ...
    protected void RadGrid1_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            command = String.Format("return EditLabTestRecord({0});", id);
            imgb.OnClientClick = command;
            ...
            command = String.Format("ariDialog('LabTests','{0}','prompt',null,0,0)", message);
            imgb.Visible = per.Create;

            switch (gdi["GeneralType"].Text)
            {
                case "LBTA":
                    gdi["GeneralType"].Text = Resources.GeneralResource.LBTA;
                    break;
                case "LBTN":
                    gdi["GeneralType"].Text = Resources.GeneralResource.LBTN;
                    break;
            }
        ...
        if (typeOfControl.Equals("System.Web.UI.WebControls.ImageButton"))
        {
            ...
            switch (imgb.ID)
            {
                ...
                case "Delete":
                    ...
                    string command = String.Format("ariDialog('Tipos prueba','{0}','prompt',null,0,0)", message);
