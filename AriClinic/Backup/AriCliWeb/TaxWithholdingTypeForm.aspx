<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaxWithholdingTypeForm.aspx.cs" Inherits="TaxWithholdingTypeForm" %>
...
<Validation IsRequired="True"></Validation>
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="210px" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Tipo de retención"></asp:Label>
        </div>
        <div id="TaxWithholdingTypeId" class="normalText">
          <asp:Label ID="lblTaxWithholdingTypeId" runat="server" Text="ID:" 
                     ToolTip="Identificador de tipo de IVA, lo usa internamente el sistema"></asp:Label>
          <br />
          <asp:TextBox ID="txtTaxWithholdingTypeId" runat="server" Enabled="false" Width="89px" TabIndex="0"></asp:TextBox>
        </div>
