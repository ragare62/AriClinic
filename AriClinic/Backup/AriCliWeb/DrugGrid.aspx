<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DrugGrid.aspx.cs" Inherits="DrugGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewDrugRecord()
          {
              var w1 = window.open("DrugForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditDrugRecord(id)
          {
              var w2 = window.open("DrugForm.aspx?DrugId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Fármacos" 
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewDrugRecord();" 
