<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsuranceGrid.aspx.cs" Inherits="InsuranceGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewInsuranceRecord()
          {
              var w1 = window.open("InsuranceForm.aspx", null, "width=670, height=550,resizable=1");
              w1.focus();
          }
          function EditInsuranceRecord(id)
          {
              var w2 = window.open("InsuranceForm.aspx?InsuranceId=" + id, null, "width=670, height=550,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Aseguradoras" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" PageSize="6" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="InsuranceId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         meta:resourceKey="GridBoundColumnResource1" ReadOnly="True" 
                                         SortExpression="InsuranceId" UniqueName="InsuranceId" 
                                         FilterControlAltText="Filter InsuranceId column">
                ...
                <telerik:GridBoundColumn DataField="Internal" 
                                         FilterControlToolTip="Filtrar por nombre" FilterImageToolTip="Filtro"
                                         HeaderText="Servicio" 
                                         meta:resourceKey="GridBoundColumnResource3" ReadOnly="True" Visible="false"  
                                         SortExpression="Internal" UniqueName="Internal" 
                                         FilterControlAltText="Filter Internal column">
                </telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewInsuranceRecord();" 
