<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptInvoicePatientForm.aspx.cs" Inherits="AriCliWeb.RptInvoicePatientForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="210px" Width="420px" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Informe de facturas de pacientes"></asp:Label>
        </div>
        <%--  Line 2 --%>
