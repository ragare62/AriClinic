<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptCategorySrvForm.aspx.cs" Inherits="AriCliWeb.RptCategorySrvForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="210px" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Informe de servicios por categoría."></asp:Label>
        </div>
        <%--  Line 2 --%>
