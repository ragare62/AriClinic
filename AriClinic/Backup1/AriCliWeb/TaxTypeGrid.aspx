<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaxTypeGrid.aspx.cs" Inherits="TaxTypeGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          function NewTaxTypeRecord()
          {
              var w1 = window.open("TaxTypeForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditTaxTypeRecord(id)
          {
              var w2 = window.open("TaxTypeForm.aspx?TaxTypeId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Tipos de IVA" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007"
            ...
            <MasterTableView AutoGenerateColumns="False" datakeynames="TaxTypeId" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="TaxTypeId" DataType="System.Int32" 
                                         FilterControlAltText="Filter TaxTypeId column" HeaderText="ID" 
                                         meta:resourcekey="GridBoundColumnResource1" ReadOnly="True" 
                                         SortExpression="TaxTypeId" UniqueName="TaxTypeId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourcekey="NewResource1" OnClientClick="NewTaxTypeRecord();" 
