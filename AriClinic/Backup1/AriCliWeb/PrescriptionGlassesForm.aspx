<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrescriptionGlassesForm.aspx.cs" Inherits="PrescriptionGlassesForm" %>
        ...
        <form id="form1" runat="server">
            ...
            <script type="text/javascript">
                function printPrescription(id) {
                    var url = "RptView.aspx?Report=prescriptionglasses&PrescriptionGlasses=" + id;
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%">
                    <table width="100%" class="normalText" style="text-align:center;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFarPrismRightEye" runat="server" CssClass="centered" Width="100px" Height="30px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtFarPrismLeftEye" runat="server" CssClass="centered" Width="100px" Height="30px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtClosePrismRightEye" runat="server" CssClass="centered" 
                                             Width="100px" Height="30px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtClosePrismLeftEye" runat="server" CssClass="centered" Width="100px" Height="30px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtBothPrismRightEye" runat="server" CssClass="centered" Width="100px" Height="30px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtBothPrismLeftEye" runat="server" CssClass="centered" Width="100px" Height="30px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="10" style="text-align:left;">
                                <div id="SignMD" class="normalText">
                                    <asp:Label ID="lblSignMD" runat="server" Text="Médico firmante:" 
                                               ToolTip="Médico firmante"></asp:Label>
                                    <br />
                                    <asp:TextBox ID="txtSignMD" runat="server" 
                                ...
                                <td colspan="10">
                                    <div ID="Buttons" class="buttonsFomat">
                                        ...
                                        <asp:ImageButton ID="btnAccept" runat="server" 
                                                         ImageUrl="~/images/disk_blue_ok.png" onclick="btnAccept_Click" 
                                                         ToolTip="Guardar" />
                                    </div>
                                </td>
                            </tr>
