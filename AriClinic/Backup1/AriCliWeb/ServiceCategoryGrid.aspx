<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceCategoryGrid.aspx.cs" Inherits="ServiceCategoryGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewServiceCategoryRecord()
          {
              var w1 = window.open("ServiceCategoryForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditServiceCategoryRecord(id)
          {
              var w2 = window.open("ServiceCategoryForm.aspx?ServiceCategoryId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
    ...
    <telerik:RadToolTipManager ID="RadToolTipManager1" runat="server" 
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Categorias de servicios" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007"
            ...
            <MasterTableView AutoGenerateColumns="False" datakeynames="ServiceCategoryId" 
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="ServiceCategoryId" DataType="System.Int32" 
                        FilterControlAltText="Filter ServiceCategoryId column" HeaderText="ID" 
                        meta:resourcekey="GridBoundColumnResource1" ReadOnly="True" 
                        SortExpression="ServiceCategoryId" UniqueName="ServiceCategoryId">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="Name" 
                        FilterControlAltText="Filter Name column" HeaderText="Categoria de servicio" 
                ...
                <CommandItemTemplate>
                    <div ID="ButtonAdd" style="padding:2px;">
                        <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                            meta:resourcekey="NewResource1" OnClientClick="NewServiceCategoryRecord();" 
