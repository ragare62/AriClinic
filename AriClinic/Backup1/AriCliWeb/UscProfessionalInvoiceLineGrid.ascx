<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UscProfessionalInvoiceLineGrid.ascx.cs" Inherits="AriCliWeb.UscProfessionalInvoiceLineGrid" %>
...
<div id="GridArea" class="normalText" style="width:100%">
  <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" 
    ...
    <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
      ...
      <Columns>
        <telerik:GridBoundColumn DataField="InvoiceLineId" DataType="System.Int32" 
      ...
      <CommandItemTemplate>
        <div ID="ButtonAdd" style="padding:2px;">
          <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                           OnClientClick="NewProfessionalInvoiceLineRecord();" 
