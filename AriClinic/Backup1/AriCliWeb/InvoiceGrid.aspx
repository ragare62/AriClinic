<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoiceGrid.aspx.cs" Inherits="InvoiceGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          function NewInvoiceRecord()
          {
              ...
              var w1 = window.open("InvoiceForm.aspx", "tck_nr1", "width=700, height=490,resizable=1");
              w1.focus();
          }
          function EditInvoiceRecord(id)
          {
              var w2 = window.open("InvoiceForm.aspx?InvoiceId=" + id, "tck_er1", "width=700, height=490,resizable=1");
              w2.focus();
          }
