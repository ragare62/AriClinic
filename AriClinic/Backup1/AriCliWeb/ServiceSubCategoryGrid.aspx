<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceSubCategoryGrid.aspx.cs" Inherits="ServiceSubCategoryGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewServiceSubCategoryRecord()
          {
              var w1 = window.open("ServiceSubCategoryForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditServiceSubCategoryRecord(id)
          {
              var w2 = window.open("ServiceSubCategoryForm.aspx?ServiceSubCategoryId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Subcategorias de servicios" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
                             DataKeyNames="ServiceSubCategoryId">
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="ServiceSubCategoryId" DataType="System.Int32" 
                ...
                <telerik:GridBoundColumn DataField="ServiceCategory.Name" 
                                         FilterControlToolTip="Filtrar por categoria" FilterImageToolTip="Filtro"
                                         HeaderText="Categoria" meta:resourceKey="GridBoundColumnResource3" 
                                         ReadOnly="True" SortExpression="ServiceCategory.Name" 
                                         UniqueName="ServiceCategory.Name">
                </telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewServiceSubCategoryRecord();" 
