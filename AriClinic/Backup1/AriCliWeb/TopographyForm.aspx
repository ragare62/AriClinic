<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopographyForm.aspx.cs" Inherits="TopographyForm" %>
      ...
      <div id="content"> 
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" Height="600px">
              ...
              <td colspan="2" class="normalText">
                <div id="Examination" style="padding:5px">
                  ...
                  <asp:ImageButton ID="btnExamination" runat="server" 
                                   ...
                                   OnClientClick="searchExamination('topography');" />
                  <br />
          ...
          <table width="100%">
            ...
            <tr>
              <td class="normalText">
                <asp:Label ID="lblK1" runat="server" Text="K1:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtK1Right" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtK1Left" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
            <tr>
              <td class="normalText">
                <asp:Label ID="lblK2" runat="server" Text="K2:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtK2Right" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtK2Left" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
            <tr>
              <td class="normalText">
                <asp:Label ID="lblAstig" runat="server" Text="Astigmatismo:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtAstigRight" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtAstigLeft" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
            <tr>
              <td class="normalText">
                <asp:Label ID="lblAxis" runat="server" Text="Eje:"></asp:Label>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtAxisRight" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
              <td class="normalText" style="text-align:center">
                <telerik:RadNumericTextBox ID="txtAxisLeft" runat="server" CssClass="centered">
                </telerik:RadNumericTextBox>
              </td>
            </tr>
