<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExaminationGrid.aspx.cs" Inherits="ExaminationGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewExaminationRecord()
          {
              var w1 = window.open("ExaminationForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditExaminationRecord(id)
          {
              var w2 = window.open("ExaminationForm.aspx?ExaminationId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Exploraciones" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="ExaminationId" DataType="System.Int32" 
                                         ...
                                         SortExpression="ExaminationId" UniqueName="ExaminationId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewExaminationRecord();" 
