<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcedureGrid.aspx.cs" Inherits="ProcedureGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          function NewProcedureRecord()
          {
              var w1 = window.open("ProcedureForm.aspx", "ProcedureForm", "width=400, height=250,resizable=1");
              w1.focus();
          }
          function EditProcedureRecord(id)
          {
              var w2 = window.open("ProcedureForm.aspx?ProcedureId=" + id, "ProcedureForm", "width=400, height=250,resizable=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Procedimientos" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007"
            ...
            <MasterTableView AutoGenerateColumns="False" datakeynames="ProcedureId" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="ProcedureId" DataType="System.Int32" 
                                         FilterControlAltText="Filter ProcedureId column" HeaderText="ID" 
                                         meta:resourcekey="GridBoundColumnResource1" ReadOnly="True" 
                                         SortExpression="ProcedureId" UniqueName="ProcedureId">
                ...
                <telerik:GridBoundColumn DataField="Service.Name" 
                                         FilterControlAltText="Filter Name column" HeaderText="Servicio asociado" 
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourcekey="NewResource1" OnClientClick="NewProcedureRecord();" 
