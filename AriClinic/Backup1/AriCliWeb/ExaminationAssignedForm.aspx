<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExaminationAssignedForm.aspx.cs" Inherits="ExaminationAssignedForm" %>
            ...
            <tr>
              <td colspan="2">
                <div id="TitleArea" class="titleBar2">
                  ...
                  <asp:Label ID="lblTitle" runat="server" Text="Exploración asignada"></asp:Label>
                </div>
              </td>
            </tr>
            <tr>
