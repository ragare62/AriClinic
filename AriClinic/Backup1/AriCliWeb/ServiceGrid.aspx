<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceGrid.aspx.cs" Inherits="ServiceGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          {
              var w1 = window.open("ServiceForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditServiceRecord(id)
          {
              var w2 = window.open("ServiceForm.aspx?ServiceId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
          ...
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                ...
                <telerik:GridBoundColumn DataField="TaxType.Name" 
                                         FilterControlToolTip="Filtrar por tipo de IVA" FilterImageToolTip="Filtro"
                                         HeaderText="Tipo de IVA"  
                                         meta:resourceKey="GridBoundColumnResource4" ReadOnly="True" 
                                         SortExpression="TaxType.Name" UniqueName="TaxType.Name">
                </telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewServiceRecord();" 
