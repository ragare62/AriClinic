...
namespace AriCliWeb
{
    public partial class UscTelephoneGrid : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["ProfessionalId"] != null)
            {
                ...
                caller = "professional"; // Called by a Healthcare Company
            }
        }
        ...
        public void RefreshGrid(bool rebind)
        {
            ...
            {
                case "hccom":
                    RadGrid1.DataSource = hc.Telephones;
                    break;
                case "clinic":
                    RadGrid1.DataSource = cl.Telephones;
                    break;
                case "patient":
                    RadGrid1.DataSource = pat.Telephones;
                    break;
                case "customer":
                    RadGrid1.DataSource = cus.Telephones;
                    break;
                case "professional":
                    RadGrid1.DataSource = prof.Telephones;
                    break;
            }
            // I must rebind?
