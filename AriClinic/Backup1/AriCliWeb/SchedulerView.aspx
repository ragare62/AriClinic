<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulerView.aspx.cs" Inherits="SchedulerView" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
                        ...
                        <AppointmentTemplate> 
                            <div id="appointment-container">
                                <div id="appointment-subject">
                                    <asp:Literal ID="AppointmentSubject" runat="server" Text='CITA PROGRAMADA'></asp:Literal>
                                </div>
                                <div id="appointment-description">
                                    <asp:Literal ID="lblAppointmentDescription" runat="server" Text=''></asp:Literal>
                                </div>
                            </div>
                        </AppointmentTemplate>
