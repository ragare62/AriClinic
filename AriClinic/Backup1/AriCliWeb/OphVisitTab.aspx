<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OphVisitTab.aspx.cs" Inherits="OphVisitTab" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Visita oftalmológica" 
        ...
        <div id="TabArea" class="normalText" style="width:100%">
            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
                ...
                <Tabs>
                    ...
                    <telerik:RadTab runat="server" Text="Motilidad / Anejos" Value="motappend">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" Text="Segmento anterior" Value="antsegment">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" Text="Fondo de ojo" Value="fundus">
                    </telerik:RadTab>
