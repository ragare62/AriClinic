<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitTypeGrid.aspx.cs" Inherits="UnitTypeGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          function NewUnitTypeRecord()
          {
              var w1 = window.open("UnitTypeForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditUnitTypeRecord(id)
          {
              var w2 = window.open("UnitTypeForm.aspx?UnitTypeId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewUnitTypeRecord();" 
