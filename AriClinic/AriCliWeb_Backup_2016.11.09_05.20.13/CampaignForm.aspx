<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampaignForm.aspx.cs" Inherits="CampaignForm" %>
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="210px" 
                ...
                <table width="100%">
                    <tr>
                        <td colspan="6">
                            <div id="TitleArea" class="titleBar2">
                                ...
                                <asp:Label ID="lblTitle" runat="server" Text="Campaña"></asp:Label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div id="CampaignId" class="normalText">
                                <asp:Label ID="lblCampaignId" runat="server" Text="ID:" 
                                           ToolTip="Identificador de categoria, lo usa internamente el sistema"></asp:Label>
                                <br />
                                <asp:TextBox ID="txtCampaignId" runat="server" Enabled="false" Width="89px"></asp:TextBox>
                            </div>
                        </td>
                        <td colspan="4">
                            <div id="Name" class="normalText">
                                <asp:Label ID="lblName" runat="server" Text="Campaña:" 
                                           ToolTip="Nombre de la campaña"></asp:Label>
                                <br />
                    ...
                    <tr>
                        <td colspan="2"></td>
                        <td colspan="2">
                            <div ID="StartDate" class="normalText" >
                                <asp:Label ID="lblStartDate" runat="server" Text="Fecha de inicio:" 
                                           ToolTip="Fecha en la que se abrió la historia"></asp:Label>
                                <br />
                                <telerik:RadDatePicker ID="rdtStartDate" runat="server" Culture="es-ES" CssClass="myCenter"  
                                                       MinDate=""  TabIndex="2">
                        ...
                        <td colspan="2">
                            <div ID="EndDate" class="normalText" >
                                <asp:Label ID="lblEndDate" runat="server" Text="Fecha de fin:" 
                                           ToolTip="Fecha en la que se abrió la historia"></asp:Label>
                                <br />
                                <telerik:RadDatePicker ID="rdtEndDate" runat="server" Culture="es-ES" CssClass="myCenter"  
                                                       MinDate=""  TabIndex="3">
                                    <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" 
                                              ViewSelectorText="x">
                                    </Calendar>
