<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroupGrid.aspx.cs" Inherits="UserGroupGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              var w1 = window.open("UserGroupForm.aspx", null, "width=450, height=250,resizable=1");
              w1.focus();
          }
          function EditUserGroupRecord(id)
          {
              var w1 = window.open("UserGroupForm.aspx?UserGroupId=" + id, null, "width=450, height=250,resizable=1");
              w1.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="350px" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Grupos de usuarios"></asp:Label>
        </div>
        <div id="GridArea" class="normalText">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" Width="436px" 
            ...
            <MasterTableView AutoGenerateColumns="false" datakeynames="UserGroupId" CommandItemDisplay="Top">
              <Columns>
                <telerik:GridBoundColumn DataField="UserGroupId" DataType="System.Int32" 
                                         HeaderText="ID" ReadOnly="true" Visible="true" 
                                         UniqueName="UserGroupId" SortExpression="UserGroupId"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Name" DataType="System.String"
                                         HeaderText="Nombre del grupo" ReadOnly="true" Visible="true" 
              ...
              <CommandItemTemplate>
                <div id="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   ...
                                   OnClientClick="NewUserGroupRecord();" />
