<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChannelGrid.aspx.cs" Inherits="ChannelGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007"
            ...
            <MasterTableView AutoGenerateColumns="False" datakeynames="ChannelId" 
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="ChannelId" DataType="System.Int32" 
                        FilterControlAltText="Filter ChannelId column" HeaderText="ID" 
                        meta:resourcekey="GridBoundColumnResource1" ReadOnly="True" 
                        SortExpression="ChannelId" UniqueName="ChannelId">
                ...
                <CommandItemTemplate>
                    <div ID="ButtonAdd" style="padding:2px;">
                        <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                            meta:resourcekey="NewResource1" OnClientClick="NewChannelRecord();" 
