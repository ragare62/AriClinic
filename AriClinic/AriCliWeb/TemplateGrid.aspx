<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplateGrid.aspx.cs" Inherits="TemplateGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <form id="form1" runat="server">
            ...
            <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
                ...
                <script type="text/javascript">
                    ...
                    function NewTemplateRecord() {
                        var w1 = window.open("TemplateForm.aspx", "TemplateForm", "width=800, height=700,resizable=1");
                        w1.focus();
                    }
                    function EditTemplateRecord(id) {
                        var w2 = window.open("TemplateForm.aspx?TemplateId=" + id, "TemplateForm", "width=800, height=700,resizable=1");
                        w2.focus();
                    }
                    ...
                    function PrintTemplate(templateId) {
                        var url = "TemplateViewForm.aspx?TemplateId=" + templateId;
                        var w = window.open(url, "templateview", "width=800,height=600,resizable=1");
                        w.focus();
                    }
                </script>
            ...
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
                ...
                <div id="TitleArea" class="titleBar2">
                    ...
                    <asp:Label ID="lblTitle" runat="server" Text="Plantillas" 
                ...
                <div id="GridArea" class="normalText" style="width:100%">
                    <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007"
                        ...
                        <MasterTableView AutoGenerateColumns="False" datakeynames="TemplateId" 
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="TemplateId" DataType="System.Int32" 
                                                         FilterControlAltText="Filter TemplateId column" HeaderText="ID" 
                                                         meta:resourcekey="GridBoundColumnResource1" ReadOnly="True" 
                                                         SortExpression="TemplateId" UniqueName="TemplateId">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="Name" 
                                                         FilterControlAltText="Filter Name column" HeaderText="Nombre de la plantilla" 
                                ...
                                <telerik:GridTemplateColumn AllowFiltering="False"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton ID="Print" runat="server" 
                                                         ...
                                                         ToolTip="Imprimir esta plantilla" />
                            ...
                            <CommandItemTemplate>
                                <div ID="ButtonAdd" style="padding:2px;">
                                    <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                                     meta:resourcekey="NewResource1" OnClientClick="NewTemplateRecord();" 
