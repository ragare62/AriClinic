º<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerGrid.aspx.cs" Inherits="CustomerGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          {
              var w1 = window.open("CustomerForm.aspx", null, "width=770, height=680,resizable=1");
              w1.focus();
          }
          function EditCustomerRecord(id)
          {
              var w2 = window.open("CustomerForm.aspx?CustomerId=" + id, null, "width=770, height=680,resizable=1");
              w2.focus();
          }
          function ViewHisAdm(id)
          {
              var w2 = window.open("CustomerTab.aspx?CustomerId=" + id, null, "width=900, height=650,resizable=1, scrollbars=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
        ...
        <div id="TitleArea" class="titleBar2">
          ...
          <asp:Label ID="lblTitle" runat="server" Text="Clientes" 
          ...
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" PageSize="6" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                ...
                <telerik:GridBoundColumn DataField="FullName" FilterControlWidth="80%"
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewCustomerRecord();" 
