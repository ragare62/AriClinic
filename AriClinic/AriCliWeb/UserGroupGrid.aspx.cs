...
public partial class UserGroupGrid : System.Web.UI.Page 
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        // cheks if it's call from another form
    ...
    {
        // load grid data
        RadGrid1.DataSource = ctx.UserGroups;
    }
    ...
    protected void RadGrid1_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (type != "S") imgb.Visible = false;

            // assign javascript function to edit button
            imgb = (ImageButton)e.Item.FindControl("Edit");
            command = String.Format("return EditUserGroupRecord({0});", id);
            imgb.OnClientClick = command;
        ...
        if (typeOfControl.Equals("System.Web.UI.WebControls.ImageButton"))
        {
            ...
            switch (imgb.ID)
            {
                ...
                case "Edit":
                    break;
                case "Delete":
                    UserGroup usg = (from ug in ctx.UserGroups
