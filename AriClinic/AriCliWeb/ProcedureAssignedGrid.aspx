<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcedureAssignedGrid.aspx.cs" Inherits="ProcedureAssignedGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
                             DataKeyNames="ProcedureAssignedId">
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="ProcedureAssignedId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         meta:resourceKey="GridBoundColumnResource1" ReadOnly="True" 
                                         SortExpression="ProcedureAssignedId" UniqueName="ProcedureAssignedId">
                ...
                <telerik:GridBoundColumn DataField="ProcedureDate" DataType="System.DateTime" DataFormatString="{0:dd/MM/yyyy}" 
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewProcedureAssignedRecord();" 
