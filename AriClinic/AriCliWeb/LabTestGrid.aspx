    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          {
              var w1 = window.open("LabTestForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditLabTestRecord(id)
          {
              var w2 = window.open("LabTestForm.aspx?LabTestId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                ...
                <telerik:GridBoundColumn DataField="UnitType.Name" 
                                         ...
                                         HeaderText="Unidades" 
                                         meta:resourceKey="GridBoundColumnResource2" ReadOnly="True" 
                                         SortExpression="UnitType.Name" UniqueName="UnitType.Name">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="MaxValue" DataType="System.Decimal" DataFormatString="{0:###0.000}" 
                                         FilterControlToolTip="Filtrar por nombre" FilterImageToolTip="Filtro"
                                         HeaderText="Máximo" 
                                         meta:resourceKey="GridBoundColumnResource2" ReadOnly="True" 
                                         SortExpression="MaxValue" UniqueName="MaxValue">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="MinValue" DataType="System.Decimal" DataFormatString="{0:###0.000}" 
                                         FilterControlToolTip="Filtrar por nombre" FilterImageToolTip="Filtro"
                                         HeaderText="Minimo" 
                                         meta:resourceKey="GridBoundColumnResource2" ReadOnly="True" 
