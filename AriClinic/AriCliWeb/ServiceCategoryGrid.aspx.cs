...
public partial class ServiceCategoryGrid : System.Web.UI.Page 
{
    ...
    {
        // load grid data
        RadGrid1.DataSource = ctx.ServiceCategories;
    }
    ...
    protected void RadGrid1_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            command = String.Format("return EditServiceCategoryRecord({0});", id);
            imgb.OnClientClick = command;
