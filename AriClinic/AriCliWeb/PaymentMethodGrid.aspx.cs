...
public partial class PaymentMethodGrid : System.Web.UI.Page 
{
    ...
    {
        // load grid data
        RadGrid1.DataSource = ctx.PaymentMethods;
    }
    ...
    protected void RadGrid1_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            command = String.Format("return EditPaymentMethodRecord({0});", id);
            imgb.OnClientClick = command;
        ...
        if (typeOfControl.Equals("System.Web.UI.WebControls.ImageButton"))
        {
            ...
            switch (imgb.ID)
            {
                ...
                case "Edit":
                    break;
                case "Delete":
                    PaymentMethod paym = (from pm in ctx.PaymentMethods
                                            where pm.PaymentMethodId == id
