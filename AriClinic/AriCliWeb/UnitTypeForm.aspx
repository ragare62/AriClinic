<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitTypeForm.aspx.cs" Inherits="UnitTypeForm" %>
            ...
            <tr>
              <td colspan="2">
                <div id="TitleArea" class="titleBar2">
                  ...
                  <asp:Label ID="lblTitle" runat="server" Text="Tipo de unidad"></asp:Label>
                </div>
              </td>
            </tr>
            <tr>
              <td>
                <div id="UnitTypeId" class="normalText">
                  <asp:Label ID="lblUnitTypeId" runat="server" Text="ID:" 
                             ToolTip="Identificador del tipo de unidad, lo usa internamente el sistema"></asp:Label>
                  <br />
                  <asp:TextBox ID="txtUnitTypeId" runat="server" Enabled="false" Width="89px"></asp:TextBox>
                </div>
              </td>
              <td>
