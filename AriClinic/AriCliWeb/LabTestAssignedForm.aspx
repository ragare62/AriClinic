<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LabTestAssignedForm.aspx.cs" Inherits="LabTestAssignedForm" %>
              ...
              if (type)
              {
                  switch (type)
                  {
                      case "Patient":
                          ...
                          break;
                      case "LabTest":
                          combo = $find("<%= rdcLabTest.ClientID %>");
                          loadCombo(combo, v1, v3);
                          break;
                  }
              }
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%">
          <table width="100%">
            ...
            <tr>
              ...
              <td>
                <div id="LabTestDate" class="normalText" style="padding:5px">
                  <asp:Label ID="lblLabTestDate" runat="server" Text="Fecha de la prueba" 
                             ToolTip="Fecha en la que se realizó la prueba."></asp:Label>
                  <br />
                  <telerik:RadDatePicker ID="rdpLabTestDate" runat="server" Width="100%">
            ...
            <tr>
              <td class="normalText" style="padding:5px">
                <div id="LabTest">
                  <asp:Label ID="lblLabTest" runat="server" Text="Prueba:" 
                             ToolTip="Prueba a asignar"></asp:Label>
                  <asp:ImageButton ID="btnLabTest" runat="server" 
                                   ImageUrl="~/images/search_mini.png" CausesValidation="false"
                                   ToolTip="Haga clic aquí para buscar una prueba" 
                                   OnClientClick="searchLabTest();" />
                  <br />
                  <telerik:RadComboBox runat="server" ID="rdcLabTest" Height="100px" 
                                       EnableLoadOnDemand="true" ShowMoreResultsBox="true" EnableVirtualScrolling="true"
                                       EmptyMessage="Escriba aquí ..." 
                                       onitemsrequested="rdcLabTest_ItemsRequested" ItemsPerRequest="10" 
                                       Width="100%" >
                  </telerik:RadComboBox>
                </div>
              </td>
