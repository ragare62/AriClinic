<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessGrid.aspx.cs" Inherits="ProcessGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          function NewProcessRecord()
          {
              var w1 = window.open("ProcessForm.aspx", null, "width=450, height=430,resizable=1");
              w1.focus();
          }
          function EditProcessRecord(id)
          {
              var w1 = window.open("ProcessForm.aspx?ProcessId=" + id, null, "width=450, height=430,resizable=1");
              w1.focus();
          }
            ...
            <MasterTableView AutoGenerateColumns="false" datakeynames="ProcessId" CommandItemDisplay="Top">
              <Columns>
                <telerik:GridBoundColumn DataField="ProcessId" DataType="System.Int32" 
                                         ...
                                         UniqueName="ProcessId" SortExpression="ProcessId"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Name" DataType="System.String"
                                         HeaderText="Proceso" ReadOnly="true" Visible="true" 
                ...
                <telerik:GridBoundColumn DataField="Description" DataType="System.String"
                                         HeaderText="Descripción" ReadOnly="true" Visible="true" 
                                         UniqueName="Description" SortExpression="Login"></telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div id="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   ...
                                   OnClientClick="NewProcessRecord();" />
