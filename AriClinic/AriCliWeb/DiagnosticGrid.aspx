<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiagnosticGrid.aspx.cs" Inherits="DiagnosticGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          {
              var w1 = window.open("DiagnosticForm.aspx", null, "width=450, height=320,resizable=1");
              w1.focus();
          }
          function EditDiagnosticRecord(id)
          {
              var w2 = window.open("DiagnosticForm.aspx?DiagnosticId=" + id, null, "width=450, height=320,resizable=1");
              w2.focus();
          }
        ...
        <div id="GridArea" class="normalText" style="width:100%">
          <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Office2007" 
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="DiagnosticId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         meta:resourceKey="GridBoundColumnResource1" ReadOnly="True" 
                                         SortExpression="DiagnosticId" UniqueName="DiagnosticId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewDiagnosticRecord();" 
