<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfessionalGrid.aspx.cs" Inherits="ProfessionalGrid" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        <script type="text/javascript">
          ...
          {
              var w2 = window.open("ProfessionalTab.aspx?ProfessionalId=" + id, null, "width=900, height=650,resizable=1, scrollbars=1");
              w2.focus();
          }
      ...
      <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" 
              ...
              <Columns>
                ...
                <telerik:GridTemplateColumn AllowFiltering="False" 
                  ...
                  <ItemTemplate>
                    ...
                    <asp:ImageButton ID="HisAdm" runat="server" Visible="false" 
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="NewProfessionalRecord();" 
        ...
        <div id="Separator" style="width:100%">
          &nbsp;
        </div>
