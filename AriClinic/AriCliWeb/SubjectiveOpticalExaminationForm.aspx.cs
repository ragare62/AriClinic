...
public partial class SubjectiveOpticalExaminationForm : System.Web.UI.Page 
{
    #region Variables declarations
    AriClinicContext ctx = null;
    User user = null;
    Refractometry refractometry = null;
    SubjectiveOpticalExamination SubjectiveOpticalExamination = null;
    int id = 0;
    Permission per = null;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        // 
        if (Request.QueryString["SubjectiveOpticalExaminationId"] != null)
        {
            id = Int32.Parse(Request.QueryString["SubjectiveOpticalExaminationId"]);
            SubjectiveOpticalExamination = CntAriCli.GetSubjectiveOpticalExamination(id, ctx);
            refractometry = SubjectiveOpticalExamination.Refractometry;
            LoadData(SubjectiveOpticalExamination);
        }
    ...
    {
        string command = "";
        if (SubjectiveOpticalExamination == null)
    ...
    protected bool CreateChange()
    {
        ...
        if (SubjectiveOpticalExamination == null)
        {
            SubjectiveOpticalExamination = new SubjectiveOpticalExamination();
            SubjectiveOpticalExamination.Refractometry = refractometry;
            UnloadData(SubjectiveOpticalExamination);
            ctx.Add(SubjectiveOpticalExamination);
        }
        else
        {
            SubjectiveOpticalExamination = CntAriCli.GetSubjectiveOpticalExamination(SubjectiveOpticalExamination.Id, ctx);
            UnloadData(SubjectiveOpticalExamination);
        }
        ctx.SaveChanges();
        ...
        Response.Redirect(String.Format("SubjectiveOpticalExaminationForm.aspx?SubjectiveOpticalExaminationId={0}", SubjectiveOpticalExamination.Id));
        return true;
    }

    protected void LoadData(SubjectiveOpticalExamination gt)
    {
    ...
    protected void UnloadData(SubjectiveOpticalExamination gt)
    {
