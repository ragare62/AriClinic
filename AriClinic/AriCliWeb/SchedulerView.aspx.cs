...
public partial class SchedulerView : System.Web.UI.Page 
{
    ...
    protected void SchedulerConfig()
    {
        ...
        RadScheduler1.DataEndField = "EndDateTime"; //change?
    ...
    protected void RadToolBar1_ButtonClick(object sender, RadToolBarEventArgs e)
    {
        switch (e.Item.Value)
        {
            ...
            case "evening":
                ...
                break;
            case "print":
                string js = String.Format("printDiary({0:yyyyMMdd}, {1});", RadScheduler1.SelectedDate, diary.DiaryId); // change?
