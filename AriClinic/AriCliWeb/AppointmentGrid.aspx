    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              var w1 = window.open("AppointmentForm.aspx", null, "width=600, height=700,resizable=1");
              w1.focus();
          }
          function EditAppointmentRecord(id)
          {
              var w2 = window.open("AppointmentForm.aspx?AppointmentId=" + id, null, "width=600, height=700,resizable=1");
              w2.focus();
          }
          function NewAppointmentRecordInTab() {
              var w1 = window.open("AppointmentForm.aspx?CustomerId=" + gup('CustomerId') + "&PatientId=" + gup('PatientId')
                                   , "apptb_nr", "width=600, height=700,resizable=1");
              w1.focus();
          }
          function EditAppointmentRecordInTab(id) {
              var w2 = window.open("AppointmentForm.aspx?CustomerId=" + gup('CustomerId') + +"&PatientId=" + gup('PatientId')
                                   + "&AppointmentId=" + id, "apptb_er", "width=600, height=700,resizable=1");
              w2.focus();
          }
