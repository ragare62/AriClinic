...
public partial class CampaignGrid : System.Web.UI.Page 
{
    ...
    {
        // load grid data
        RadGrid1.DataSource = ctx.Campaigns;
    }
    ...
    protected void RadGrid1_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            command = String.Format("return EditCampaignRecord({0});", id);
            imgb.OnClientClick = command;
        ...
        if (typeOfControl.Equals("System.Web.UI.WebControls.ImageButton"))
        {
            ...
            switch (imgb.ID)
            {
                ...
                case "Edit":
                    break;
                case "Delete":
                    Campaign cpg = (from c in ctx.Campaigns
