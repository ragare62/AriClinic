...
public partial class DiagnosticAssignedGrid : System.Web.UI.Page 
{
    ...
    protected void RadGrid1_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        if (e.Item is GridCommandItem)
        {
            ...
            if (visit != null)
                imgb.OnClientClick = "NewDiagnosticAssignedRecordInVisit();";
        }
        if (e.Item is GridDataItem)
        {
            ...
            name = gdi["Patient.FullName"].Text + ": " + gdi["Diagnostic.Name"].Text;
            ...
            if (visit != null)
                command = String.Format("return EditDiagnosticAssignedRecordInVisit({0});", id);
            ...
            command = String.Format("ariDialog('Diagnosticos asignados','{0}','prompt',null,0,0)", message);
            imgb.Visible = per.Create;
        }
    }
    ...
    protected void RefreshGrid(bool rebind)
    {
        ...
        else
        {
            ...
            if (visit != null)
                RadGrid1.DataSource = visit.DiagnosticAssigneds;
        }
        if (rebind)
            RadGrid1.Rebind();
    }
